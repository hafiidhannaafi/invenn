    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Formulir Edit Data Peralatan</h5>

                       <!-- validation Form Elements -->

              <form action="/data-peralatan/update/{{$inputbarang->id}}" method="POST" enctype="multipart/form-data" needs-validation" novalidate>
                @csrf
                <div class="row mb-3">
