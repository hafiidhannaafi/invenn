                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form name="inputjenisaset" action="{{ route('inputjenisaset') }}" method="POST" enctype="multipart/form-data" class=" needs-validation" novalidate>
                          @csrf
                            <div class="col-12">
                              {{-- <label for="inputNanme4" class="form-label">Nama Jenis Aset</label> --}}
                              <input type="text" class="form-control" name="nama_jenisaset" placeholder="Masukan jenis aset"id="inputNanme4"required>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> 
                       ...
                       <a href="/datajenisaset/edit/{{$data->id}}" type="button" class="btn btn" style="background-color: #05b3c3; color:#FFFFFF"><i class="bi bi-pencil"></i></a>
                        <a href="/datajenisaset/hapusjenisaset/{{$data->id}}" onclick="return confirm('Hapus Data?')" type="button" class="btn btn-danger"><i class="bi bi-trash delete"></i></a>
