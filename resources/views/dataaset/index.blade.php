              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <div class="row">
                   ...
                   <a href="/data-aset/edit/{{$data->id}}" type="button" class="btn btn-sm" style="background-color: #05b3c3; color:#FFFFFF"><i class="bi bi-pencil"></i></a>
                   <a href="/data-aset/hapusdataaset/{{$data->id}}" onclick="return confirm('Hapus Data?')" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash delete"></i></a>
                    </td>
                    @endif
                    @endforeach
