        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="/data-asetbergerak/form" type="button"  class="btn btn-sm" style="background-color:  #012970; color:#FFFFFF">Tambah</a>
          ...
          <div class="card mb-3">
            <div class="row g-0">
              ...
              <a href="/data-asetbergerak/edit/{{$data->id}}" type="button" class="btn btn-sm" style="background-color: #05b3c3; color:#FFFFFF"><i class="bi bi-pencil"></i></a>
                        <a href="/data-asetbergerak/hapus/{{$data->id}}" onclick="return confirm('Hapus Data?')" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash delete"></i></a>
                    </td>
                    @endif
                    @endforeach
