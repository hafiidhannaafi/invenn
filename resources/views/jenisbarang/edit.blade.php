      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form  action="/jenisbarang/update/{{$jenisbarang->id}}" method="POST" enctype="multipart/form-data" class=" needs-validation" novalidate>
              {{csrf_field()}}
              <div class="row mb-3">
                {{-- <label for="validationCustom01" class="col-sm-2 col-form-label">Nama Jenis Aset</label> --}}
                <div class="col-sm-10">
                  <input  name="jenis_barang" value="{{$jenisbarang->jenis_barang}}" type="text" id="jenis_barang " class="form-control"  required>
